...
CREATE DATABASE Northwind  CHAR SET utf8mb4 COLLATE utf8mb4_bin ; 
...
INSERT INTO SalesOrder(OrderId, CustomerId, EmployeeId, OrderDate, RequiredDate, ShippedDate, ShipperId, Freight, ShipName, ShipAddress, ShipCity, ShipRegion, ShipPostalCode, ShipCountry)
